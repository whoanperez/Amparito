...
export const DEMO_SCRIPTS: Record<string, DemoBeat[]> = {
  ...
  Andres: [
    { role: "user", say: "Hola, soy Andrés, tengo 28 años, soltero y sin hijos, y acabo de comprar una moto." },
  ...
  Jaime: [
    { role: "user", say: "Hola, soy Jaime, tengo 58 años, vivo con mi esposa y ya tengo un seguro exequial con Colsubsidio." },
